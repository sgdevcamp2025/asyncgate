...
struct SignUpNameAndPasswordView: View {
    ...
    var body: some View {
        VStack {
            ...
            SignTextField(stepCaption: "사용자명", placeholder: "", text: $signUpViewModel.name)
                .padding(.top, 24)
                .padding(.bottom, 10)
            ...
            VStack(alignment: .leading) {
                ...
                PasswordField(password: $signUpViewModel.passWord)
            }
                .padding(.bottom, 30)
            
            NavigationLink(destination: SignBirthView(signUpViewModel: signUpViewModel)) {
